...
<body>
    ...
    <div class="container">
            		...
            		<img src="images/actas_portada.jpg" width="1170" height="248" class="img-responsive mg30top">
			                    ...
			                    <div class="col-xs-12 col-md-3">
			                        <div class="menu-interna">
			                            <ul>
			                                ...
			                                <li><a href="svlActas?id=" class="act-izq">Actas por número</a></li>
			                            </ul>
			                        </div>
			                    </div>
					                                ...
					                                <p>&nbsp;</p>
					                                    <form id="myfsorm" name="myform" class="horizontal-form" method="post" action="svlActas">
																<div class="col-md-3">
																	...
																	<div class="col-md-2">
																		<button  type="submit"  onclick="svlActas?id" 
