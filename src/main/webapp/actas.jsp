											...
											<div class="col-xs-12 pbot30">
				                                ...
				                                <div id="page-wrap">
				                                    <table class="table17" cellspacing="0">
														...
														<%String[] aMesa = (String[]) session.getAttribute("ListaMesas");
															int mesa=10;
    														for(String mesas :aMesa ) {														
    														  if(mesa++ % 10 == 0){ %><tr> <% } %>
															<td bgcolor="#C1C1C1"  style="cursor:pointer">
															   <a href="svlActas?nroMesa=<%= mesas %>"><%= mesas %></a>
															</td>	 
															<%if(mesa% 10 == 0){ %><tr><%} %>
											...
											<div class="row pbot30">
				                                <div class="col-lg-8 centered">
				                                    <div class="col-xs-12 col-md-12 col-lg-12">
														<table>
															<tbody>
																<tr><td colspan="10"><div class="conte-paginador">
																<span class="paginador-txt">Total de mesas:<%=((String[] ) session.getAttribute("ListaMesas")).length %></span>
																</div>
																</td>
																</tr>  
																<tr><td>&nbsp;</td></tr>
