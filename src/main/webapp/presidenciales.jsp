			...
			<section class="menu navbar-default menu05">
				...
				<nav class="navbar-collapse bs-navbar-collapse collapse"
					...
					<ul class="nav navbar-nav">
						...
						<li class="bt-rojo"><a href="svlParticipacion">PARTICIPACIÓN CIUDADANA</a></li>
					</ul>
				</nav>
			</section>
								...
								<div class="col-xs-11">
									<h3>
										<span class="glyphicon glyphicon-circle-arrow-right"
											aria-hidden="true" style="font-size: 19px"></span> SEGUNDA ELECCIÓN PRESIDENCIAL 2016: RESULTADOS PRESIDENCIALES
									</h3>
								</div>
				...
				<div class="col-xs-12">
					...
					<script>
						...
						function VerGraficoBarras() {
						  $("#divUbicombo").hide();
						  $(".subtitle").html("GRÁFICO DE RESULTADOS EN VOTOS PRESIDENCIAL - VOTOS VÁLIDOS");
							...
							<div id="divDetalle"><br>
								...
								<div class="col-xs-12 pbot30">
									<div class="row cont-recto">
										<div class="col-lg-8 centered">																																																						<p><b>GRÁFICO DE RESULTADOS DE VOTOS VÁLIDOS, BLANCOS Y NULOS</b></p>
